...
import com.kozhukhar.carshop_online.util.captcha.executor.CaptchaCookieExecutor;

import javax.servlet.http.HttpServletRequest;
import javax.servlet.jsp.JspWriter;
import java.io.IOException;

public class CookieCaptchaFactory extends CaptchaAbstractFactory {

    @Override
    public void startCaptchaExec(HttpServletRequest request, JspWriter out) throws AppException {
        try {
            Runnable captchaRun = new CaptchaCookieExecutor(request, initCaptchaUtil(out, request));
