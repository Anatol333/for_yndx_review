...
public class FinderByThreadInit extends PrimeFinder {

    @Override
    public List<Integer> find(Integer countOfThread, Integer from, Integer frequency, Integer lastFrequency) {
        ...
        findByThread(countOfThread, from, frequency, lastFrequency, findPrimeNum, primeNumbers, threadInitialize);
